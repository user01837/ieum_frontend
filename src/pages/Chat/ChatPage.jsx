  ...
  return (
    <div className="chat-page">
            ...
            <div className="chat-input-area" {...getRootProps()}>
              ...
              <div className="chat-input-row">
                <div className="chat-input-box">
                  ...
                  />
                  <button className="chat-attach-btn" title="파일 첨부" onClick={open}>
                    <IconAttach />
                  </button>
                </div>
                <button
                  ...
                  onClick={handleSend}
                  disabled={(!draft.trim() && attachedFiles.length === 0) || sendChatMessageMutation.isPending}
                >
                  <IconSend /> 전송
                </button>
              </div>
      ...
      {isPickerOpen && (
        <EmployeeSearchModal
          multiSelect
          currentDept={currentUser?.deptName}
