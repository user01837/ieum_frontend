...
function KnowlCreate() {
    ...
    const [scope, setScope] = useState('department'); // 'department' or 'all'
    ...
    return (
        <div className="dcontent">
            ...
            <div className="card">
                ...
                <textarea
                    className="notice"
                    placeholder="주의사항이나 반드시 알아야 할 내용을 입력하세요."></textarea>
            </div>
            ...
            <div className="card">
                ...
                <div className="form-group" style={{marginBottom: 0}}>
                    ...
                    <p className="hint">{scope === 'department' ? '같은 과 내의 직원들만 이 지식베이스를 조회할 수 있습니다.' : '모든 부서의 직원들이 이 지식베이스를 조회할 수 있습니다.'}</p>
                </div>
            </div>
